...
function decodeUplink(input) {
    ...
    function parseLoRaPayload(bytes) {
        ...
        while (index < bytes.length) {
            ...
            if (metricId === 40) { // 0b101000
                warnings.push("Decode device boot");
            ...
            metrics['QC'] = 1; // Imposta QC a 1 se almeno una metrica è decodificata
        }
  ...
  try {
      ...
      //result.metrics.QC = sresult.qc || 0;
